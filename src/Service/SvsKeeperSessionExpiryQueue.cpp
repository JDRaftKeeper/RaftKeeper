...
void SvsKeeperSessionExpiryQueue::addNewSessionOrUpdate(int64_t session_id, int64_t timeout_ms)
{
...
std::vector<int64_t> SvsKeeperSessionExpiryQueue::getExpiredSessions() const
{
    int64_t now = getNowMilliseconds();
