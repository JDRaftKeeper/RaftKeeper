...
struct ClearableHashSetState
{
    ...
    void write(RK::WriteBuffer & wb) const         { RK::writeBinary(version, wb); }
    void writeText(RK::WriteBuffer & wb) const     { RK::writeText(version, wb); }

    /// Deserialization, in binary and text form.
    void read(RK::ReadBuffer & rb)                 { RK::readBinary(version, rb); }
    void readText(RK::ReadBuffer & rb)             { RK::readText(version, rb); }
};
