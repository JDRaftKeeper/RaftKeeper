...
inline StringRef & ALWAYS_INLINE keyHolderGetKey(RK::ArenaKeyHolder & holder)
{
    return holder.key;
}

inline void ALWAYS_INLINE keyHolderPersistKey(RK::ArenaKeyHolder & holder)
{
...
inline void ALWAYS_INLINE keyHolderDiscardKey(RK::ArenaKeyHolder &)
{
}
...
inline StringRef & ALWAYS_INLINE keyHolderGetKey(RK::SerializedKeyHolder & holder)
{
    return holder.key;
}

inline void ALWAYS_INLINE keyHolderPersistKey(RK::SerializedKeyHolder &)
{
}

inline void ALWAYS_INLINE keyHolderDiscardKey(RK::SerializedKeyHolder & holder)
{
