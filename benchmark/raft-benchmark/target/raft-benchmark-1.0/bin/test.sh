...
#done
java -cp $classpath com.jd.raft.benchmark.Main "raft" "NODE1:5102,NODE2:5102,NODE3:5102" 1 256 3 "create"
java -cp $classpath com.jd.raft.benchmark.Main "raft" "NODE1:5102,NODE2:5102,NODE3:5102" 1 256 3 "mix"
