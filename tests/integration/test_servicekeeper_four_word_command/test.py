...
def test_cmd_conf(started_cluster):
    ...
    try:
        ...
        assert result["service_port"] == "5102"
        ...
        assert result["log_dir"] == "/var/lib/clickhouse/coordination/log"
        assert result["snapshot_dir"] == "/var/lib/clickhouse/coordination/snapshots"
        ...
        assert result["reserved_log_items"] == "10000000"
